...
app.config["MONGO_URI"] = "mongodb+srv://sirio:WlLryCFHOXnBKMbx@cluster0.jlysa.mongodb.net/Relab?retryWrites=true&w=majority" #Importante qui va specificato il nome del DB
